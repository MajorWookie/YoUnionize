...
export const PROMPT_VERSIONS: Record<SectionPromptKind, string> = {
  ...
  mda: 'mda@v2',
  risk_factors: 'risk_factors@v2',
  business_overview: 'business_overview@v2',
  legal_proceedings: 'legal_proceedings@v2',
  executive_compensation: 'executive_compensation@v2',
  financial_footnotes: 'financial_footnotes@v2',
  cybersecurity: 'cybersecurity@v2',
  controls_and_procedures: 'controls_and_procedures@v2',
  related_transactions: 'related_transactions@v2',
  proxy: 'proxy@v2',
  event_8k: 'event_8k@v3',
