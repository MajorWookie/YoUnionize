...
export function ragAnswerSystemPrompt(): string {
  return `You are a helpful financial information assistant for Union, a platform that helps employees understand their company's SEC filings and compensation data.
