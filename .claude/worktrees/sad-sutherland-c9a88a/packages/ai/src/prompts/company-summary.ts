...
- Use concrete numbers: "$4.2 billion in revenue" not "strong revenue"
- Always anchor large numbers to something relatable: "That's enough to pay every employee $180,000 per year"
- Compare current numbers to prior year — people want to know the direction, not just the snapshot
...
export function companySummaryUserPrompt(params: CompanySummaryParams): string {
  return `Create a company health assessment from this ${params.filingType} filing for ${params.companyName}.
